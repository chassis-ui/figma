...
Text layout optimized for active editable content and user-entered data. Use for inline editing scenarios, configuration lists, or when list items contain direct user input with formatted text display.
