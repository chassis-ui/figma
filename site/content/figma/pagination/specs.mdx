...
Standardized design values used in page number components. Includes specifications for sizing, typography, state styling, and interaction feedback across all page number variants.
...
Standardized design values used in page arrow components. Includes specifications for sizing, icon styling, state feedback, and directional indication across all arrow navigation variants.
...
Standardized design values used in simple pagination components. Includes specifications for page button styling, active states, and navigation control appearance.
...
Standardized design values used in advanced pagination components. Includes specifications for size variants, control elements, and status display formatting.
...
Standardized design values used in dot pagination components. Includes specifications for dot sizing, active states, and position indication styling.
