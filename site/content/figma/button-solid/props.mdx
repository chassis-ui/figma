---
title: Button Solid
description: Filled interactive elements with solid background colors that create strong visual hierarchy and clear action affordance for primary and contextual user interactions.
toc: true
---
