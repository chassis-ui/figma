...
Standardized design system values that define consistent visual properties across story components. These tokens ensure visual coherence while enabling flexible theme customization and brand adaptation.
...
- Granular tokens that affect all story components.
