...
Standardized design values used in badge components. Includes specifications for each variant and style-dependent labeling rules for consistent appearance and behavior across all badge implementations.
