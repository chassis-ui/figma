...
<CxVariant img="progress-bar-segmentation-10-segments">
...
<CxVariant img="progress-bar-segmentation-12-segments">
...
<CxVariant img="progress-bar-state-current-state">
...
<CxVariant img="progress-step-type-thumb">
...
<CxVariant img="progress-step-type-chip">
...
<CxVariant img="progress-step-state-next">
...
<CxVariant img="progress-step-state-current">
...
<CxVariant img="progress-step-state-past">
...
<CxVariant img="progress-flow-type-thumb">
...
<CxVariant img="progress-flow-type-chip">
...
<CxVariant img="progress-flow-size-large">
...
<CxVariant img="progress-flow-size-small">
...
<CxVariant img="progress-flow-state-current-step">
...
<CxVariant img="loading-indicator-label-external">
...
<CxVariant img="loading-indicator-label-internal">
