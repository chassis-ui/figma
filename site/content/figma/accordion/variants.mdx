...
<CxVariant img="item-spacing-basic">
...
<CxVariant img="item-spacing-flush">
...
<CxVariant img="item-state-collapsed">
...
<CxVariant img="item-state-expanded">
...
<CxVariant img="item-size-medium">
...
<CxVariant img="spacing-flush" wide={true}>
