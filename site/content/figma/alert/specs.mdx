...
Standardized design values used in alert window components. Includes specifications for each variant and state-dependent styling rules for consistent appearance and behavior across all alert window implementations.
...
Standardized design values used in alert screen components. Includes specifications for each variant and state-dependent styling rules for consistent appearance and behavior across all alert screen implementations.
