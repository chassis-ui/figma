---
title: Notification
description: Contextual message components that communicate system updates, alerts, or status information to users with appropriate visual emphasis and actionable options.
toc: true
---
