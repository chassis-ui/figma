...
<CxVariant img="nav-link-state-idle">
...
<CxVariant img="nav-link-state-hover">
...
<CxVariant img="nav-link-state-active">
...
<CxVariant img="nav-link-state-disabled">
...
<CxVariant img="navbar-size-large" wide>
...
<CxVariant img="navbar-size-small" wide>
