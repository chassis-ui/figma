---
title: Navbar
description: Navigation bar components that provide primary site navigation with links, branding, and interactive elements for consistent horizontal navigation interfaces.
toc: true
---
