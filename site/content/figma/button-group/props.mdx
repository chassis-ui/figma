---
title: Button Group
description: Grouped interactive button collections that organize related actions into visually connected sets for clear action relationships and cohesive interface design.
toc: true
---
