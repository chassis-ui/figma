...
<CxVariant img="mobile-top-navigation-type-basic">
...
<CxVariant img="mobile-top-navigation-type-modal">
...
<CxVariant img="mobile-top-navigation-type-stack">
...
<CxVariant img="nav-control-bar-type-center">
...
<CxVariant img="nav-control-bar-type-left">
...
<CxVariant img="nav-control-bar-type-large-title">
...
<CxVariant img="nav-title-item-type-basic">
...
<CxVariant img="nav-title-item-type-dropdown">
...
<CxVariant img="nav-title-item-type-left">
...
<CxVariant img="nav-title-item-type-subtitle">
...
<CxVariant img="nav-title-item-type-large">
...
<CxVariant img="nav-title-item-type-trip">
...
<CxVariant img="nav-title-item-type-chat">
...
<CxVariant img="nav-title-item-type-logo">
...
<CxVariant img="nav-action-state-active">
...
<CxVariant img="nav-action-state-passive">
...
<CxVariant img="nav-action-type-back">
...
<CxVariant img="nav-action-type-parent">
...
<CxVariant img="nav-action-type-text-basic">
...
<CxVariant img="nav-action-type-text-emphasized">
...
<CxVariant img="nav-action-type-menu">
...
<CxVariant img="nav-action-type-close">
...
<CxVariant img="nav-action-type-icons">
...
<CxVariant img="nav-action-type-leading-icon">
...
<CxVariant img="nav-action-type-trailing-icon">
...
<CxVariant img="nav-action-type-avatar">
...
<CxVariant img="nav-action-type-pager">
...
<CxVariant img="nav-utility-bar-type-search">
...
<CxVariant img="nav-utility-bar-type-trip-search">
...
<CxVariant img="nav-utility-bar-type-segments">
...
<CxVariant img="nav-utility-bar-type-tabs">
...
<CxVariant img="nav-utility-bar-type-chips">
...
<CxVariant img="nav-utility-bar-type-calendar">
