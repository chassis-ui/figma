...
<CxVariant img="mobile-bottom-navigation-style-basic">
...
<CxVariant img="mobile-bottom-navigation-style-glass">
...
<CxVariant img="mobile-bottom-navigation-type-tabs">

#### Tabs

Standard mobile navigation presentation with tab-based interface styling for primary section navigation and iOS-style tab bar patterns. Use for main application sections, primary feature navigation, or when maintaining conventional mobile tab navigation patterns with clear hierarchical access.

</CxVariant>

<CxVariant img="mobile-bottom-navigation-type-actions">

#### Action Bar

Enhanced mobile navigation presentation with action-focused interface styling for task completion and form submission functionality. Use for form submissions, task completion flows, or when providing focused action interfaces that require clear functional emphasis.

</CxVariant>

<CxVariant img="mobile-bottom-navigation-type-progress">
...
<CxVariant img="nav-tabs-type-standard">
...
<CxVariant img="nav-tabs-type-floating-action">
...
<CxVariant img="nav-actions-type-stacked">

#### Stacked

Stacked action presentation with vertical button arrangement for multiple action organization and space-efficient action display. Use for multi-step processes, form submissions with multiple options, or when providing comprehensive action access with clear hierarchical organization.

</CxVariant>

<CxVariant img="nav-actions-type-side-by-side">

#### Side by Side

Side-by-side action presentation with horizontal button arrangement for balanced action emphasis and traditional action bar patterns. Use for paired actions, confirmation workflows, or when maintaining balanced action presentation with equal emphasis and clear action relationships.
...
<CxVariant img="nav-progress-type-purchase-summary">
...
<CxVariant img="nav-progress-type-step-progress">
