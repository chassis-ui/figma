...
Neutral elevated styling variant for tertiary floating actions or low-saturation alternatives. Use when maintaining visual hierarchy while providing persistent functional access to less prominent features with subtle elevation.

#### Danger

Destructive floating action styling that signals potentially harmful or irreversible operations. Use for critical actions like deleting important content, canceling processes, or operations requiring careful consideration with persistent access.

#### Success

Positive confirmation styling for completion and success states with elevation. Use for finalizing critical processes, completing important transactions, or confirming successful operations that provide positive feedback with prominence.

#### Warning

Cautionary elevated styling variant that signals attention-required floating actions. Use for operations involving warnings, critical confirmations, or potentially risky operations requiring persistent access and user attention.

#### Info

Informational elevated styling variant for knowledge-based floating actions and feature access. Use for accessing help systems, opening critical information dialogs, or navigating to essential informational content.
