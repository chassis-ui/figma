...
description: Elevated action buttons with shadow styling that remain persistently visible, typically positioned fixed on the page to provide immediate access to primary actions.
toc: true
---
