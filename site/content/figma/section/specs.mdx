...
Standardized design values used in section header components. Includes specifications for size variants, spacing configurations, content hierarchy, and visual presentation across all section header variants.
...
Standardized design values used in section footer components. Includes specifications for action layouts, button arrangements, size variants, and interaction patterns across all section footer variants.
...
Standardized design values used in section block components. Includes specifications for content organization, spacing configurations, layout structures, and visual hierarchy across all section block variants.
