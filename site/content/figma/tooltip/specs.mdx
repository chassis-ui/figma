...
Standardized design values used in tooltip components. Includes specifications for each variant and state-dependent styling rules for consistent appearance and behavior across all tooltip implementations.
