...
<CxVariant img="tab-item-activity-active">
...
<CxVariant img="tab-item-activity-inactive">
...
<CxVariant img="tab-item-style-regular">
...
<CxVariant img="tab-item-style-fancy">
...
<CxVariant img="tab-item-size-large">
...
<CxVariant img="tab-item-size-medium">
...
<CxVariant img="tab-item-size-small">
...
<CxVariant img="tab-item-state-idle">
...
<CxVariant img="tab-item-state-hover">
...
<CxVariant img="tab-item-state-press">
...
<CxVariant img="tab-item-state-disabled">
...
<CxVariant img="tab-bar-type-top">
...
<CxVariant img="tab-bar-type-bottom">
...
<CxVariant img="tab-bar-type-fancy">
