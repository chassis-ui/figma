...
Configurable properties that control the appearance, behavior, and functionality of outline button components.

## Outline Buttons

Properties that define the visual state and interactive behavior of outline button elements.
