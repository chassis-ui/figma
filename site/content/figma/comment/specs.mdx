...
Standardized design values used in comment item components. Includes specifications for each variant and state-dependent styling rules for consistent appearance and behavior across all comment item implementations.
...
Standardized design values used in comment form components. Includes specifications for input organization, submission controls, and consistent content creation experience across all comment form implementations.
