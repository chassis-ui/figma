...
Properties that define the visual state and delivery feedback behavior of message status indication elements within messaging systems.
...
Controls the visibility and presentation of textual status information that provides detailed delivery state context within message status displays.

## Embed Item Props

Properties that define the visual state and content presentation behavior of embedded media elements within message interfaces.
