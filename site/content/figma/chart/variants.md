...
> [!NOTE]
> Bar variants are not direct variants of the Bar Chart component. To achieve these configurations, you need to dive into the component and change the type variant of the nested "_ Bar Item" component.
