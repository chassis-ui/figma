...
Standardized design values used in hero carousel components. Includes specifications for each size variant, pagination styling, and sequential navigation presentation rules for consistent visual prominence and behavior across all hero carousel implementations.
...
Standardized design values used in card carousel components. Includes specifications for each size variant, card spacing, pagination indicators, and horizontal navigation presentation rules for consistent browsing experience and behavior across all card carousel implementations.
...
Standardized design values used in small carousel components. Includes specifications for mobile layout variants, touch interaction parameters, and simplified presentation rules for consistent mobile navigation experience and behavior across all small carousel implementations.
