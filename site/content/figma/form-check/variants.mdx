...
<CxVariant img="check-input-type-checkbox">
...
<CxVariant img="check-input-type-radio">
...
<CxVariant img="check-input-type-indeterminate">
...
<CxVariant img="check-input-selection-true">
...
<CxVariant img="check-input-selection-false">
...
<CxVariant img="check-input-size-small">
...
<CxVariant img="check-input-size-medium">
...
<CxVariant img="check-input-size-large">
...
<CxVariant img="check-input-state-idle">
...
<CxVariant img="check-input-state-disabled">
...
<CxVariant img="check-input-state-error">
...
<CxVariant img="check-input-state-success">
...
<CxVariant img="check-input-state-primary">
...
<CxVariant img="form-check-type-checkbox">
...
<CxVariant img="form-check-type-radio">
...
<CxVariant img="form-check-type-indeterminate">
...
<CxVariant img="form-check-selection-true">
...
<CxVariant img="form-check-selection-false">
...
<CxVariant img="form-check-size-small">
...
<CxVariant img="form-check-size-medium">
...
<CxVariant img="form-check-size-large">
...
<CxVariant img="form-check-state-idle">
...
<CxVariant img="form-check-state-disabled">
...
<CxVariant img="form-check-state-error">
...
<CxVariant img="form-check-state-success">
...
<CxVariant img="form-check-state-primary">
